  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-white shadow-sm flex flex-col pt-4 overflow-hidden font-sans pb-4">
        ...
        <div className="px-5 flex gap-4 mb-5">
          {/* Logo Card */}
          ...
          <div className="flex flex-col justify-center flex-grow">
            ...
            <div className="flex items-center justify-between mb-2">
              <h1 className="text-[22px] font-semibold text-[#181d5f] tracking-tight leading-none">Welcome to Basera</h1>
              <button 
            ...
            <button 
              ...
              className="bg-[#edf9f0] border border-[#d1e8d6] rounded-full px-3 py-1.5 flex items-center gap-2 self-start active:scale-95 transition-transform"
            >
