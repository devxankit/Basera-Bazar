...
const SECTIONS = [
  {
    ...
    content:
      'We collect your name, phone number, email address, Aadhaar details, bank account information, GPS location data (for attendance), and uploaded verification documents when you register as a field executive.',
  },
  {
    title: '2. How We Use Your Data',
    content:
      'Your data is used to verify your identity, track attendance and performance, process salary and commission payouts, manage partner onboarding records, and improve the platform.',
  },
  {
    title: '3. Data Sharing',
    content:
      'We do not sell your personal data. Your identity documents are stored securely and accessible only to authorized admin personnel. Your basic details may be visible to partners you onboard.',
  },
  {
    title: '4. Your Rights',
    content:
      'You can request access to, correction of, or deletion of your personal data by contacting us at support@baserabazar.com. You can also request account deactivation through your team leader.',
  },
];

export default function ExecutivePrivacyPolicy() {
  const navigate = useNavigate();

  const { data: rawData } = useQuery({
    queryKey: ['privacyExecutive'],
    queryFn: () => api.get('/admin/system/page-content?key=CONTENT_PRIVACY_EXECUTIVE').then(r => r.data),
    staleTime: 5 * 60 * 1000,
  });

  const content = rawData?.data || {};
  const lastUpdated = content.last_updated || 'January 2025';
  const intro = content.intro || 'Basera Bazar values your privacy. This policy explains what data we collect from field executives and how we use it.';
