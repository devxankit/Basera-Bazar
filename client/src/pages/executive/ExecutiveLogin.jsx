        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
          <form onSubmit={handleLogin} className="space-y-6 sm:space-y-8">
            <div className="space-y-4 sm:space-y-6">
              {/* Phone Input */}
              <div className="space-y-2">
                <label className="text-[9px] sm:text-[11px] font-medium text-slate-400 uppercase tracking-[0.2em] ml-1">Phone Number</label>
                <div className="group relative transition-all duration-300">
                  <div className="absolute left-5 top-1/2 -translate-y-1/2 flex items-center gap-2 sm:gap-3">
                    <Phone className="text-slate-400 group-focus-within:text-indigo-600 transition-colors" size={16} />
              ...
              {/* Password Input */}
              <div className="space-y-2">
                <label className="text-[9px] sm:text-[11px] font-medium text-slate-400 uppercase tracking-[0.2em] ml-1">Secure Password</label>
                <div className="group relative transition-all duration-300">
                  <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors" size={16} />
                  <input 
          ...
          <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-slate-50 flex flex-col items-center gap-4">
            <p className="text-xs sm:text-[13px] font-medium text-slate-400">New to Basera Bazar Executive?</p>
            <Link to="/executive/register" className="w-full py-3.5 sm:py-4 border-2 border-indigo-50 text-indigo-600 font-medium rounded-xl sm:rounded-2xl flex items-center justify-center gap-2 hover:bg-indigo-50/50 transition-all text-sm sm:text-base uppercase tracking-widest">
              CREATE ACCOUNT
            </Link>
          </div>
        </div>
        ...
        {showNotFoundModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 text-left">
            ...
            >
              ...
              <div className="w-20 h-20 bg-indigo-50 rounded-[2rem] flex items-center justify-center mb-6 text-indigo-600">
                <ShieldCheck size={32} />
              </div>
              <h3 className="text-2xl font-black text-slate-900 tracking-tight mb-2 uppercase">Account Not Found</h3>
              <p className="text-slate-500 font-medium text-[15px] leading-relaxed mb-10">
                We couldn't find an executive account with these details. Would you like to create a new one instead?
              </p>
