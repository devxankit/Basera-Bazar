          ...
          {['active', 'delivered', 'cancelled'].map((tab) => (
            <button
              ...
              className={`flex-1 py-3 rounded-xl text-[13px] font-bold capitalize transition-all ${
                activeTab === tab ? 'bg-white text-[#001b4e]' : 'text-white/60'
              }`}
            >
              {tab}
            </button>
                    ...
                    <div key={idx} className="flex gap-4 items-start">
                       ...
                       <div className="flex-grow">
                          ...
                          <div className="flex flex-col gap-3 mt-3">
                             <div className={`self-start flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-bold border ${
