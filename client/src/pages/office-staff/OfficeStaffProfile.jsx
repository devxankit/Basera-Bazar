...
export default function OfficeStaffProfile() {
  ...
  const handleSave = async (e) => {
    ...
    setSaving(true);
    try {
      const { data } = await api.put('/office-staff/profile', form);
      if (data.success) {
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-teal-600 rounded-2xl p-5 text-white">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-teal-200 text-[11px] font-bold uppercase tracking-widest mt-0.5">Office Staff</p>
              {profile?.state && (
                <p className="text-teal-300 text-[11px] font-medium mt-1 flex items-center gap-1">
        ...
        {isEditing && (
          ...
          >
            ...
            <button type="submit" disabled={saving} className="w-full flex items-center justify-center gap-2 py-3 bg-teal-600 text-white rounded-xl text-sm font-bold hover:bg-teal-700 disabled:opacity-60 shadow-sm">
